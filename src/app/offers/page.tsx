    ...
    <div className="min-h-screen pt-24">
      <section className="relative h-screen flex items-center justify-center overflow-hidden -mt-24">
        <div className="absolute inset-0 z-0">
          <Image
            src="https://images.unsplash.com/photo-1543489822-c49534f3271f?auto=format&fit=crop&w=2000&q=80"
            alt="Offers at Aurelia"
            fill
        ...
        <div className="relative z-20 text-center px-6">
          ...
          <p className="text-white/80 text-lg max-w-2xl mx-auto font-light mb-12">
            We are finalizing our exclusive curated packages. Please check back shortly for exceptional direct booking rates and seasonal getaways.
          </p>
